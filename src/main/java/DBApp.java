...
public class DBApp {
    ...
    public void verifyCreation(
        ...
        if (f)
            throw new DBAppException("storage.Table with this name already exists");
    ...
    public String verifyInsertion(String strTableName,
        ...
        boolean f = validateTableExistence(strTableName);
        if(!f)
            throw new DBAppException("storage.Table with this name doesn't exists");
    ...
    public String verifySelection(SQLTerm[] arrSQLTerms,
        ...
        if(!validateTableExistence(tableName))
            throw new DBAppException("storage.Table doesn't exist");
